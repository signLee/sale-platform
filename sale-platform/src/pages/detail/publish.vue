  ...
  <div class="sales-board">
    ...
    <div class="sales-board-form">
      ...
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <v-selection :selection="tradeList"></v-selection>
        </div>
      </div>
      <div class="sales-board-line">
        <div class="sales-board-line-left">
...
<script type="text/ecmascript-6">
  import VMulChooser from '../../components/base/mutiChoose/mutiChoose.vue'
  import VCounter from '../../components/base/counter/counter.vue'
  ...
  export default{
    ...
    components:{
      VMulChooser,VCounter,VSelection
    }
  }
</script>
