...
<template>
  <div @click="resetComponent">
    ...
    <v-dialog :isShow="isShowAboutDialog" @on-close="onCloseDialog('isShowAboutDialog')">
      <p>
    ...
    <v-dialog :isShow="isShowLogDialog" @on-close="onCloseDialog('isShowLogDialog')">
      <log-form @has-log="onSuccessLogin"></log-form>
    </v-dialog>
    <v-dialog :isShow="isShowRegDialog" @on-close="onCloseDialog('isShowRegDialog')">
      <reg-form></reg-form>
    </v-dialog>
  </div>
</template>
...
<script type="text/ecmascript-6">
  ...
  import LogForm from  '../logoForm/logoForm.vue'
  ...
  export default{
    ...
    methods: {
      ...
      onSuccessLogin(data){
        ...
        this.onCloseDialog('isShowLogDialog');
      },
      resetComponent(){
